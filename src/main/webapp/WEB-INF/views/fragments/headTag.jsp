...
<script src="<c:url value="/webjars/jquery-ui/1.10.3/ui/jquery.ui.core.js" />"></script>

<script src="<c:url value="/webjars/jquery-ui/1.10.3/ui/jquery.ui.datepicker.js" />"></script>
